...
class Usuarios extends Controllers
{
	...
	public function Usuarios()
	{
		...
		$data['page_id'] = 2;
		$data['page_tag'] = "usuarios - Home Market";
		$data['page_title'] = "usuarios- Home Market";
	...
	public function UpdateUsuario()
	{
		if ($_POST) {
			...
			$strstatus = intval(strClean($_POST['listStatus2']));
			//$strstatus = 1;
	...
	public function getUsuario()
	{
		...
		<button class="btn btn-info btn-sm btnEditUsuario"   onClick="fntEditUsuario12(' . $arrData[$i]['id_usuario'] . ')" onClick="fntRolesUsuario()"
		    title="Editar usuario"><i></i>Actualizar</button>	

			<button class="btn btn-danger btn-sm btnDelUsuario" onClick="fntDelUsuario(' . $arrData[$i]['id_usuario'] . ')" title="Eliminar usuario"><i ">Eliminar</i></button>	
