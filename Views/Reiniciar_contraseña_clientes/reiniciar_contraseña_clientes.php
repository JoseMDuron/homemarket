            ...
            <div class="card rounded-3 text-black" style="max-width: 70%;">
              <div class="col-lg-6" style="max-width: 100%;">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <img class="logo_login" src="Assets/images/logo.jpeg" alt="User Image" style="max-width: 100px;">
                    <h4 class="mt-1 mb-5 pb-1">HOME MARKET</h4>
                  </div>
                  <form  id="form_Reinicar_clientes" name="form_Reinicar_clientes" action="" class="login-form" >
                  <div class="form-outline mb-4">
                   ...
                   <label class="form-label" for="form2Example11">INGRESA TU CORREO ELECTRONICO PARA REESTABLECER TU CONTRASEÑA.</label>
                    ...
                    <label class="form-label" for="form2Example11">Correo:</label>
                      <input type="email" id="txtEmailReiniciarCliente" class="form-control" placeholder="" name="txtEmailReiniciarCliente"/>
                    </div>
