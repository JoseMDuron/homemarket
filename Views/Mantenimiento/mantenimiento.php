...
<main class="app-content">
        ...
        <div>
            ...
            <h1><i class="fa fa-dashboard"></i> <?= $data['page_title'] ?>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalScrollable">
                    Agregar Nuevo Registro del estado
                </button>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalScrollableTitle">Agregar Nuevo Estado de pedido</h5>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">Estados de pedidos</div>
            </div>
        </div>
    </div>
    <div class="row">
                                    ...
                                    <table class="table table-hover table-bordered dataTable no-footer" id="sampleTable" role="grid" aria-describedby="sampleTable_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="sampleTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 339.922px;">Estado del pedido</th>
                                        ...
                                        <tbody>
                                            <tr role="row" class="odd">
                                                ...
                                                <td>CANCELADO</td>
                                                <td>Se canceló el pedido al cliente</td>
                                                <td>Activo</td>
                                                <td>22/01/2022</td>
                                                <td>22/01/2022</td>
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td>COMPLETADO</td>
                                                <td>Se completo correctamente el pedido</td>
                                                <td>activo</td>
                                                <td>22/01/2022</td>
                                                <td>22/01/2022</td>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>PENDIENTE</td>
                                                <td>Pedido en estado pediente para la entrega</td>
                                                <td>Activo</td>
                                                <td>22/01/2022</td>
                                                <td>22/01/2022</td>
                                                <td>
                                            ...
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">3</td>
                                                <td>EN PROCESO</td>
                                                <td>Pedido en estado proceso de entrega</td>
                                                <td>Activo</td>
                                                <td>22/01/2022</td>
                                                <td>22/01/2022</td>
                                                <td>
