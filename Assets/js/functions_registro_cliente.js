...
var formregistroClientes = document.querySelector('#formregistroClientes');
formregistroClientes.onsubmit = function (e) {
    e.preventDefault();
    ...
    var ajaxUrl = base_url + '/Registro_clientes/setRegistroUsuario'; //URL para acceder al metodo
    var formData = new FormData(formregistroClientes);
